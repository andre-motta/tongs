...
Record the actual author model/setting, independent Sol reviewer findings and
resolutions. Astra records the final current-head review and integration decision.
